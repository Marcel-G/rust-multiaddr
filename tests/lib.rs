...
fn construct_success() {
    ...
    ma_valid(
        ...
        vec![Ip6(addr6),Tcp(4001), Wss("/".into()), P2p(peer_id("QmNnooDu7bfjPFoTZYxMNLWUQJyrVwtbZg5gBMjTezGAJN")), P2pCircuit, WebRTC, P2p(peer_id("QmcgpsyWgH8Y8ajJz1Cu72KnS5uo2Aa2LpzU7kinSupNKC"))],
    );
